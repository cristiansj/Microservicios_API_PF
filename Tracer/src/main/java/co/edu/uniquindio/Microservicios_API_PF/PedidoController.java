...
public class PedidoController {
    ...
    @GET
    @Path("{id_pedido}/tracer")
    public Response trace(@PathParam("id_pedido") String id_pedido,  @HeaderParam("Authorization") String authToken){
        ...
        return Response.ok(getRoute(id_pedido)).build();
    }
